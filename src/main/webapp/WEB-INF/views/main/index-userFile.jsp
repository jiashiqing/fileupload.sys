...
<body>
<div class="right">
    <div class="field" style="display:none;"><input id="field_id" value="${field}"></div>
    <div class="rtop"><a href="#" onclick="showCont()" class="update" id="upload_button">上传</a></div>
    <div class="pd15">
        <div class="rsearch">
            <form name="searchForm" id="search_form" action="${pageContext.request.contextPath}/userFile/indexPage?field=${field}"
                  method="post">
                <%--                	<h2><span>上传类型：</span>--%>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="uptab">
            ...
            <c:forEach items="${lst_file.dataRows}" var="ite">
                <tr>
                    ...
                    <td width="10%"><a href="#" onclick="javascripy:downloadFile('${ite.id}');"
                                       title="下载文件[${ite.fileName}]"><img
                            src="${pageContext.request.contextPath}/images/icon.gif" width="12" height="15"/></a></td>
        ...
        <div class="pagerBar">
            <div class="pageBarbox clearfix">
                <ul class="otherInfo">
                    <li><label>共&nbsp;${lst_file.records}&nbsp;条&nbsp;&nbsp;每页&nbsp;${lst_file.rows}&nbsp;条&nbsp;&nbsp;当前第&nbsp;${lst_file.page}&nbsp;页</label>
                    </li>
                </ul>
                <!-- epages -->
                <div class="epages clearfix">
                    ...
                    <c:if test="${lst_file.page != 1 && lst_file.total > 1}">
                        <a href="#"
                           onclick="javascript:window.location.href='${pageContext.request.contextPath}/userFile/indexPage?page=1&field=${field}&uploadType=${uploadType}&fileName=${fileName}'">首页</a>
                        <a href="#"
                           onclick="javascript:window.location.href='${pageContext.request.contextPath}/userFile/indexPage?page=${lst_file.page-1}&field=${field}&uploadType=${uploadType}&fileName=${fileName}'">上一页</a>
                    </c:if>
                    ...
                    <c:if test="${lst_file.page != lst_file.total && lst_file.total != 0}">
                        <a href="#"
                           onclick="javascript:window.location.href='${pageContext.request.contextPath}/userFile/indexPage?page=${lst_file.page+1}&field=${field}&uploadType=${uploadType}&fileName=${fileName}'">下一页</a>
                        <a href="#"
                           onclick="javascript:window.location.href='${pageContext.request.contextPath}/userFile/indexPage?page=${lst_file.total}&field=${field}&uploadType=${uploadType}&fileName=${fileName}'">尾页</a>
                    </c:if>
                </div>
                <!-- epages -->
            </div>
...
<div class="yxbox">
    ...
    <div class="pd15">
        <form name="uploadForm" id="upload_form" action="#" method="post" enctype="multipart/form-data">
            <p class="mb20"><input type="file" name="file" id="fileToUpload" title="请选择要上传的文件" onchange="fSubmit();">
            </p>
